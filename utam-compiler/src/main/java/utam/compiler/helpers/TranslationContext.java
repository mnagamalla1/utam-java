...
public final class TranslationContext {
  ...
  private static String buildUnionTypeKey(String elementName, List<String> basicTypes) {
    String key = String.join("_", basicTypes);
    return String.join("_", elementName, key);
  }
